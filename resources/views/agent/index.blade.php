        ...
        <div class="content-wrapper">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="/agents/create" class="btn btn-success">@lang('Add Agent')</a>
                    <a href="/agency/create" class="btn btn-success">@lang('Import Agent')</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $data_user->agent_firstname }}  {{ $data_user->agent_lastname }}</td>
                                <td>{{ $data_user->country }}</td>
                                <td>{{ $data_user->Email }}</td>
                                <td>{{ $data_user->contact_number }}</td>
                                <td class="text-center">
                                    <a href="/agent/edit/{{ $data_user->id}}">
