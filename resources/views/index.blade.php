...
<head>
    ...
    <style>
        ...
        .rounded-progress .progress-bar {
            border-radius: 25px;
            /* Use a large value to get full-rounded corners */
        }
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header" style="background-color: #ff7a00; box-shadow: 2px 2px 5px rgba(0, 0, 0, 0.5);">
            ...
            <div class="row col-12 pt-3">
                <div class="col-lg-6">
                    ...
                    <h3 class="font-weight-bold" style="padding-left: 2%;">Welcome To Visadone <h2 style="padding-left: 2%;">{{ session('email') }}</h2>
                    </h3>
                            ...
                            <section class="col-lg-6 connectedSortable">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <canvas id="revenue-chart-canvas" height="300" width="600px;" style="height: 300px;"></canvas>
                                    </div><!-- /.card-header -->
                                                                    ...
                                                                    <div class="table-responsive mb-3 mb-md-0 mt-3">
                                                                        <table class="table table-borderless report-table">
                                                                            <tr>
                                                                                ...
                                                                                <td class="w-100 px-0">
                                                                                    <div class="progress progress-md mx-4">
                                                                                        <div class="progress-bar bg-primary" role="progressbar" style="width: {{ $data->visa_type_selected == 'standard visa' ? $data->count : 0 }}%" aria-valuenow="{{ $data->visa_type_selected == 'standard visa' ? $data->count : 0 }}" aria-valuemin="0" aria-valuemax="100">
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                                <td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="w-100 px-0">
                                                                                    <div class="progress progress-md mx-4">
                                                                                        <div class="progress-bar bg-warning" role="progressbar" style="width: {{ $data->visa_type_selected == 'sticker visa' ? $data->count : 0 }}%" aria-valuenow="{{ $data->visa_type_selected == 'sticker visa' ? $data->count : 0 }}" aria-valuemin="0" aria-valuemax="100">
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                                <td>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="w-100 px-0">
                                                                                    <div class="progress progress-md mx-4">
                                                                                        <div class="progress-bar bg-danger" role="progressbar" style="width: {{ $data->visa_type_selected == 'Bussiness' ? $data->count : 0 }}%" aria-valuenow="{{ $data->visa_type_selected == 'Bussiness' ? $data->count : 0 }}" aria-valuemin="0" aria-valuemax="100">
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                                                <td>
