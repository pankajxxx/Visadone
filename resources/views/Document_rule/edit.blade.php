    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <div class="main-panel">
                <form action="/offers_rule/update" method="POST">
                    @csrf
                     ...
                     <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12 grid-margin">
                                <div class="card">
                                    <div class="card-body">
                                        <h3 class="card-description">Edit Document Rule Offer</h3>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="nationality"
                                                                ...
                                                                @foreach ($country as $option)
                                                                    @if ($data->nationality == $option->country_name)
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="destination"
                                                                ...
                                                                <option value="">Select Nationality</option>
                                                                @foreach ($country as $option)
                                                                    @if ($data->destination == $option->country_name)
                                                                        <option name="nationality"
                                                                            value="{{ $option->country_name }}"
                                                                            selected>
                                                                            {{ $option->country_name }}</option>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="document_type"
                                                            ...
                                                            @foreach ($document as $option)
                                                                <option name="nationality"
                                                                    value="{{ $option->document_name }}" @if ($data->document_type == $option->document_name) selected @endif>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="document_name" value="{{$data->document_name}}"
                                            ...
                                            <div class="col-md-6">
                                                <div class="switch-field">
                                                    <input type="radio" id="radio-one-1" name="document_mandatory"
                                                        value="Yes" @if($data->document_needed == "Yes") checked @endif>
                                                    <label for="radio-one-1">Yes</label>
                                                    <input type="radio" id="radio-two-1" name="document_mandatory"
                                                        value="No" @if($data->document_needed == "No") checked @endif>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="message"  class="form-control mb-2 mr-sm-2" rows="4" cols="60">{{$data->document_description}}</textarea>
                                                </textarea>
                                                    {{--  --}}
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="switch-field">
                                                    <input type="radio" id="radio-one-3"
                                                        name="document_requiredments" value="always" @if($data->visa_type == "always") checked @endif>
                                                    <label for="radio-one-3">Always</label>
                                                    <input type="radio" id="radio-two-3"
                                                        name="document_requiredments" value="conditionally" @if($data->visa_type == "conditionally") checked @endif>
                    ...
                    <input type="submit" class="float-left btn btn-success"  value="Update" style="
                    margin-left: 2%;
                    margin-bottom: 2%;
                    margin-top: 1%;
                    width: 114px;
