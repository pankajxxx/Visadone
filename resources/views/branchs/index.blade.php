        ...
        <div class="content-wrapper">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="/branch/create" class="btn btn-success">@lang('Add Branch')</a>
                    <a href="/agency/create" class="btn btn-success">@lang('Import Branch')</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($data as $data_user)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $data_user->country_code }}{{ $data_user->id }}</td>
                                    <td>{{ $data_user->name }}</td>
                                    <td>{{ $data_user->country_name }}</td>
                                    <td>{{ $data_user->country_code }}</td>
                                    <td><a href="/branch/edit/{{ $data_user->id }}"><i class="fa fa-pencil"></i></a>
                                    </td>
