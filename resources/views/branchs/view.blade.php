...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <h3 class="card-header">Edit Branch</h3>
            <form action="/branch/update/{{ $branch[0]->id }}" method="POST">
                @csrf
                <div class="form-sample" style="padding-left: 14px;padding-right:10px;">
                                    ...
                                    <select class="form-control" name="country" id="country" onchange="getbranch()">
                                        ...
                                        @foreach ($country as $option)
                                            <option name="country" value="{{ $option->country_name }}"
                                                @if ($branch[0]->country_name == $option->country_name) selected @endif>
                                                {{ $option->country_name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="input-field">
                                    <input type="text" value="{{ $branch[0]->name }}" name="branch_name" required
                                        spellcheck="false">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="input-field with-divider">
                                    @if (isset($branch_bank[0]))
                                        <input type="text" value="{{ $branch_bank[0]->branch_bank_number }}"
                                            name="branch_bank" required spellcheck="false">
                                    @else
                                        <!-- Handle the case when $branch_bank is empty or doesn't have the expected data -->
                                        <input type="text" name="branch_bank" required spellcheck="false">
                                        <!-- You can display an error message or provide an appropriate fallback content -->
                                    @endif

                                    <label>Branch Bank Number</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="input-field">
                                    <input type="text" value="{{ $branch[0]->branch_address }}" name="branch_address"
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="input-field with-divider">
                                    <input type="number" value="{{ $branch[0]->contact_number_branch }}"
                                        name="contact_number" required spellcheck="false">
                            ...
                            <div class="form-group">
                                <div class="input-field">
                                    <select class="form-control custom-select" name="status" required>
                                        ...
                                        <option value="active" @if ($branch[0]->active == 'active') selected @endif>
                                            Active</option>
                                        <option value="inactive" @if ($branch[0]->active == 'inactive') selected @endif>
                                            In-Active</option>
                                    </select>
                                    <!-- <label>User Type</label> -->
                                </div>
