                                                                                ...
                                                                                <div class="black-card">
                                                                                    <div class="card_1 text-center">
                                                                                        <div class="card-body_1">
                                                                                            <i
                                                                                                class="fas fa-cloud-upload-alt fa-5x mb-3"></i>
                                                                                            <h5 class="card-title">Drag
                                                                                                &amp;
                                                                                                Drop to Upload</h5>
                                                                                            ...
                                                                                            <input type="file"
                                                                                                id="file-upload-1">
                                                                                            <label
                                                                                                for="file-upload-1">Browse</label>
                                                                                        ...
                                                                                        <div class="black-card">
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <input
                                                                                                        type="file"
                                                                                                        id="file-upload-{{ $i }}-{{ $key }}"
                                                                                                        name="file-upload-{{ $i }}-{{ $key }}"
                                                                                                        required

                                                                                                        style="margin-right: 3%; display: none;">
                                                                                                    <label
                                                                                                        for="file-upload-{{ $i }}-{{ $key }}"
                                                                                                        class="file-label">Browse</label>

                                                                                                    {{-- <label
                                                                                                        for="file-upload-{{ $i }}-{{ $key }}">Browse</label> --}}
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    @endif
