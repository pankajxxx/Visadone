                        ...
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5" style="background-color: rgb(244 244 244);" >
                            ...
                            <form action="{{route('user.store')}}" method="POST" class="pt-3">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" name="first_name" id="exampleInputEmail1"
                                        placeholder="Enter First Name">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" name="last_name" id="exampleInputEmail1"
                                        placeholder="Enter Last Name">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" name="email" id="exampleInputEmail1"
                                        placeholder="Enter Email Address">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" name="mobno" id="exampleInputEmail1"
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" name="country_iso" id="exampleInputEmail1"
                                ...
                                <div class="form-group">
                                    <input type="password" class="form-control form-control-lg"
                                        id="exampleInputPassword1" name="password" placeholder="Re-Enter Password">
                                </div>
                                <div class="mt-3">
