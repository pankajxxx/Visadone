...
<body class="hold-transition sidebar-mini layout-fixed">
       ...
       @extends('testing.sidebar')
        ...
        <div class="content-wrapper">
            ...
            <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                <h3 class="font-weight-bold" style="padding-left: 2%;">Welcome To Visadone <h2 style="padding-left: 2%;">{{ session('name') }}</h2>
                </h3>
                <h6 class="font-weight-normal mb-0" style="padding-left: 2%;">All systems are running smoothly! You have
    ...
    {{-- DO NOT Change Untile Controller Data is Ready --}}
    <script>
        const xValues = ["UAE", "USA", "Kenya", "Sounth Africa", "New Zealand"];
    ...
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <script>
        const zValues = ["Italy", "France", "Spain", "USA", "Argentina"];
        const qValues = [55, 49, 44, 24, 15];
        const barColors = [
            "#b91d47",
            "#00aba9",
            "#2b5797",
