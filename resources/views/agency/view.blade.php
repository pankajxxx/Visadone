...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <h3 class="card-header">Edit Agency</h3>
                ...
                <div class="form-sample" style="padding-left: 14px;padding-right:10px;">
                                ...
                                <div class="input-field with-divider">
                                    <select class="form-control" name="country"
                                        ...
                                        @foreach ($country as $option)
                                            <option name="country"
                                                value="{{ $option->country_name }}" @if($agency[0]->country == $option->country_name ) selected @endif>
                                                {{ $option->country_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class="form-control" name="currency"
                                        ...
                                        @foreach ($currency as $option)
                                            <option name="currency"
                                                value="{{ $option->country_currency }}" @if($agency[0]->currency == $option->country_currency ) selected @endif>
                                ...
                                <div class="input-field">
                                    <select class="form-control" name="branch"
                                        ...
                                        @foreach ($branch as $option)
                                            <option name="branch"
                                                value="{{ $option->name }}" @if($agency[0]->branch_name == $option->name ) selected @endif>
                                                {{ $option->name }}
                                            </option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="input-field with-divider">
                                    <input type="text" value={{$agency[0]->agent_role}} name="role" required
                                        spellcheck="false">
                                        <input type="hidden" value={{$agency[0]->id}} name="id">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="input-field with-divider">
                                    <input type="text" value={{$agency[0]->agency_name}} name="agency_name" required
                                        spellcheck="false">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="input-field">
                                    <input type="text"  value={{$agency[0]->address_line}} name="agency_address" required
                                        spellcheck="false">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="input-field with-divider">
                                    <input type="number" value={{$agency[0]->contact_number_branch}} name="contact_number" required
                                        spellcheck="false">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <div class="input-field with-divider">
                                    <input type="email" value={{$agency[0]->email}} name="email" required
                                        spellcheck="false">
                            ...
                            <div class="form-group">
                                <div class="input-field">
                                    <button type="Submit" class="btn btn-primary"><i
                                            class="ti-check mr-2"></i>Update</button>
                                </div>
                            </div>
                        </div>
                    </div>
